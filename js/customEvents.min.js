...
if(elemObj&&elemObj.textStr){elemObj.value=elemObj.textStr;}
if(isPoint&&event==='click'&&elemObj.series.options.allowPointSelect){var defaultFunction=function(event){if(elemObj.select){elemObj.select(null,e.ctrlKey||e.metaKey||e.shiftKey);}};HC.fireEvent(elemObj,event,e,defaultFunction);}
