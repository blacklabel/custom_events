...
return{events:events,element:element,eventsPoint:eventsPoint,elementPoint:elementPoint};},renderItem:function(){return{events:this.options.itemEvents,element:this.group};},drawCrosshair:function(){var crosshair=this.options.crosshair;return{events:crosshair&&crosshair.events,element:this.cross}}}};customEvents=HC.Chart.prototype.customEvent;customEvents.init();}));