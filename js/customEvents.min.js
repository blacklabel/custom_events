...
return false;});}else{addEvent(SVGelem.element,event,function(e){e.stopPropagation();e.preventDefault();if(elemObj&&elemObj.textStr){elemObj.value=elemObj.textStr;}
