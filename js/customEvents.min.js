...
if(series&&defaultOptions[series.type]&&defaultOptions[series.type].marker){var chart=series.chart,normalizedEvent=chart.pointer.normalize(e);elemObj=series.searchPoint(normalizedEvent,series.kdDimensions===1);}
